<template>
  <section v-if="allRegularEvents.length > 0" class="signature-events">
    <div class="container">
      <client-only>
        <div v-if="$i18n.locale == 'en'" class="signature-events-title">
          <h3>Regular Events & Activities</h3>
        </div>
        ...
        <div class="signature-events-cards">
          <a
            :href="`/event-details/?id=${singleEvent.id}`"
            v-for="singleEvent in allRegularEvents"
            :key="singleEvent.id"
