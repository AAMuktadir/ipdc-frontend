  ...
  <div v-if="displayData">
    ...
    <div class="header-div" v-if="cover">
      <div class="deposit-title">
        ...
        <div
          class="deposit-description"
          v-if="isBangla"
          v-html="cover.descriptionBangla"
        />
        <!-- {{
    ...
    <div class="header-div" v-else>
      <div class="deposit-title">
        ...
        <h3 class="deposit-sub-heading" v-if="page == 'durjoy'">
          {{
            isBangla
              ? "নাবিকদের জন্য বিশেষ আর্থিক প্রস্তাবনা"
              : "Privilege Proposition for Mariners"
          }}
        </h3>
...
export default {
  ...
  computed: {
    ...
    displayData() {
      const source = this.coverImage || this.cover;
