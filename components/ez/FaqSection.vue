...
export default {
  ...
  methods: {
    async getFaqByPage() {
      const defaultFaqs = [
        {
          question: "What is IPDC EZ?",
          answer:
            "IPDC EZ is the official digital app of IPDC Finance PLC. The app lets you easily open savings and term deposit accounts, make installment payments, and manage your deposits — all digitally, securely, and from anywhere.",
        },
        {
          question: "Who can sign up for IPDC EZ?",
          answer:
            "Any Bangladeshi citizen with a valid NID, active mobile number, and successful customer verification can register for IPDC EZ. The platform is open to both new users and existing IPDC customers.",
        },
        {
          question: "What types of information can I access through IPDC EZ?",
          answer:
            "Personal & Contact Information, Statement & Certificates, Service Requests, Security & Biometric Login options.",
        },
        {
          question: "How do I register for an IPDC EZ account?",
          answer:
            "Download the IPDC EZ app, select Register, enter your details, verify your mobile number and email, and complete registration.",
        },
        {
          question: "How do I login to my IPDC EZ account?",
          answer:
            "Open the IPDC EZ app, enter your registered mobile number and password.",
        },
        {
          question: "What should I do if I forget my password?",
          answer:
            "Use the 'Forgot Password' option, verify via OTP, and set a new password.",
        },
        {
          question: "Where can I see all the details of my IPDC accounts?",
          answer:
            "You can view personal information, deposit account details, account summaries, maturity dates, interest, and nominee information.",
        },
        {
          question: "Can I manage more than one account through IPDC EZ?",
          answer:
            "Yes. Multiple accounts under your name can be viewed and managed through a single login.",
        },
        {
          question:
            "Can I obtain my account statement and tax certificate through IPDC EZ?",
          answer:
            "Yes, these documents can be downloaded directly from the app.",
        },
        {
          question: "Can I save my progress of deposit application?",
          answer: "Yes. IPDC EZ automatically saves your application progress.",
        },
        {
          question: "How will I know whether my deposit account has opened? ",
          answer:
            "You will get notifications through SMS and Email with your digital receipt of deposit.",
        },
      ];
